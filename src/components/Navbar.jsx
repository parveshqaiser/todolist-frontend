                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                                ...
                                <button className="hover:bg-slate-100 p-1 rounded transition-colors flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 ml-2">
                            ...
                            <button className="hover:bg-red-50 p-1.5 sm:p-2 rounded-lg transition-colors group flex-shrink-0">
